...
export function CoverPage({ 
  ...
  return (
    <div 
      className="min-h-screen flex flex-col items-center justify-center p-4 md:p-6 lg:p-8 py-12 md:py-16 pb-24 md:pb-28 lg:pb-32 relative overflow-hidden print:h-[297mm] print:py-10 print:px-12 print:pb-12"
