      ...
      <div className={`max-w-5xl mx-auto ${hasMultipleSegments ? 'space-y-6 print:space-y-4' : 'space-y-10 print:space-y-8'}`}>
        ...
        <div className={`grid gap-4 ${!flight.isDirect && flight.segments.length >= 2 ? 'grid-cols-2' : 'grid-cols-1'} ${hasMultipleSegments ? 'print:gap-3' : ''}`}>
          {flight.segments.map((segment, index) => (
            <div key={index} data-blur-key={`flightTransitSegmentCard-${index}`} className={`bg-white rounded-2xl p-4 shadow-lg border border-purple-100 print:break-inside-avoid ${flight.isDirect ? 'max-w-2xl mx-auto w-full' : ''} ${hasMultipleSegments ? 'print:p-3' : 'p-6'}`}>
                  ...
                  <div className="flex items-center justify-center py-2 gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      {isEditMode ? (
                        ...
                        <span
                          data-blur-key="flightTransitDirectBadge"
            ...
            <div className="flex items-center justify-center gap-2">
              <div className="flex items-center gap-2">
                {isEditMode ? (
                  ...
                  <span
                    data-blur-key="flightTransitTransitLabel"
              ...
              {isEditMode ? (
                ...
                <div className="flex items-center gap-2">
                  <span
                    data-blur-key="flightTransitTransitTime"
        ...
        <div data-blur-key="flightTransitChecklistCard" className={`bg-purple-50 border border-purple-200 rounded-xl print:break-inside-avoid ${hasMultipleSegments ? 'p-4' : 'p-6'}`}>
          <div className="flex items-center gap-2 mb-3">
            {isEditMode ? (
              ...
              <h3
                data-blur-key="flightTransitChecklistTitle"
